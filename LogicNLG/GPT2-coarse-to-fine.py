...
if __name__ == '__main__':
    ...
    if args.do_train:
        ...
        for epoch_idx in range(args.start_epoch, args.start_epoch + args.epoch):
            ...
            if args.model == 'gpt2':
                torch.save(model.state_dict(), '{}/GPT_stage{}_C2F_type_ep{}.pt'.format(args.id, args.stage, epoch_idx))
            else:
                torch.save(model.state_dict(), '{}/GPT_stage{}_C2F_type_medium_ep{}.pt'.format(args.id, args.stage, epoch_idx))
